<script setup>
// const myChannel = "https://www.youtube.com/watch?v=pgWZLS75Nmo"
...
<template>
    <!-- <a v-bind:href="myChannel">youtube</a> Old way-->
    <!-- <a :href="myChannel">youtube</a> 
    <img :src="amazingImage" :alt="alt" :width="imgWidth" :height="imgHeight">  -->
    <img :="imgCouple"></img>
</template>
<style>
</style>